...
function themeFiles() {
    ...
    wp_register_style('slick', get_stylesheet_directory_uri() . '/assets/lib/slick.css', array(), ASSETS_VERSION, 'screen');
    wp_enqueue_style('slick');
    wp_register_style('aos', get_stylesheet_directory_uri() . '/assets/lib/aos.css', array(), ASSETS_VERSION, 'screen');
    wp_enqueue_style('aos');

    wp_register_script('jquery', get_stylesheet_directory_uri() . '/assets/lib/jquery-3.6.0.min.js', array(), ASSETS_VERSION, true);
    wp_enqueue_script('jquery');
    wp_register_script('jqueryMask', get_stylesheet_directory_uri() . '/assets/lib/jquery.mask.min.js', array(), ASSETS_VERSION, true);
    wp_enqueue_script('jqueryMask');
    wp_register_script('slick', get_stylesheet_directory_uri() . '/assets/lib/slick.min.js', array(), ASSETS_VERSION, true);
    wp_enqueue_script('slick');
    wp_register_script('aos', get_stylesheet_directory_uri() . '/assets/lib/aos.js', array(), ASSETS_VERSION, true);
